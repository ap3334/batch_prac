...
public class DevInitData {
    ...
    public CommandLineRunner initData(MemberService memberService, ProductService productService, CartService cartService) {
        return args -> {
            ...
            Product product2 = productService.create("쉬폰 OPS", 72000, "청평화 A-1-15", Arrays.asList(new ProductOption("WHITE", "44"), new ProductOption("WHITE", "55"), new ProductOption("BLACK", "44"), new ProductOption("BLACK", "55")));
